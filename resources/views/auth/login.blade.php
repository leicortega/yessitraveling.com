...
@section('body')
	<form action="{{ route('login') }}" method="POST" class="login-form bg-white shadow-sm d-flex flex-column justify-content-center">
		...
		<h3 class="d-flex align-items-center m-0 mb-4 text-capitalize justify-content-center">
		...
		<div class="form-group">
			<input type="email" name="email" class="@error('email') border border-danger @enderror form-control" placeholder="correo@email.com" value="{{ old('email') }}">
			@error('email')
        ...
        <div class="container">
            <div class="row justify-content-center">
                <button class="btn btn-block text-capitalize">Ingresar</button>
            </div>
        </div>
